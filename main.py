...
def create_account():
    ...
    with open("user_accounts.json", "r+") as file:
        ...
        user_accounts.append({"Username": username, "password": hashed_password})
...
def login():
    ...
    if username in user_accounts and verify_password(hashed_password, user_accounts[username]['password']):
...
# Firt Version of the delete all accounts function
   # admin_username = input("Enter admin username: ")
   # admin_password = input("Enter admin password: ")
